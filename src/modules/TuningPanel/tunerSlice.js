...
export const counterSlice = createSlice({
    ...
    reducers: {
        ...
        updateStringState: (state, action) => {
            ...
            state.pitchList[stringIdx ? stringIdx : state.activeStringIndex].state = newState;
        },
...
export const { updatePitchValue, updateActiveStringIndex, updatePitchList, updateStringState } = counterSlice.actions
